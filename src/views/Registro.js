  ...
  handleClick(event) {
      ...
      if (event === 'codigopostalnuevo') {
        ...
        if( this.state.smsuser != this.state.idSMS) {
          this.setState({ msgcodigoverificados:true, msgeneral: 'Código incorrecto, introdúcelo correctamente o presiona el botón reenviar código para obtener uno nuevo'})
          setTimeout(()=>{
        ...
        { close => (
          ...
          <div className="contrato-container">
            ...
            <div className="row date-contrato">
              <p>He leído y acepto los términos y condiciones de la oferta expresada en el presente contrato. Cualquier duda o comentario por favor comunicate al (55)25052455.</p>
    ...
    <h4 className="text-left title-form">Referencia</h4>
      ...
      <div className="container">
          ...
          <div className="col-sm mobile-col">
            <div className="form-group-dos">
              <div className="pointer_atras extra-margin-left" onClick={() => this.setState({stateView : 'datoscasa'})}> Atrás </div>
            </div>
          </div>
...
datosEmpleo = () => {
  return (
    ...
    <div className="row">
      <div className="col-sm mobile-col">
        <div className="pointer_atras" onClick={() => this.setState({stateView : 'historial'})}> Atrás </div>
      </div>
      <div className="col-sm mobile-col">
...
datosbancarios = () => {
  return (
    ...
    <div className="row">
      <div className="col-sm mobile-col">
        <div className="pointer_atras" onClick={() => this.setState({stateView : 'datosempleo'})}> Atrás </div>
      </div>
      <div className="col-sm mobile-col">
...
confirmacondiciones = () => {
  ...
  return (
    ...
    <div className="container">
        ...
        <div className="col-sm">
          <div className="form-group slider-group">
            <label>¿En cuánto tiempo lo quieres pagar?</label>
              <Slider
                defaultValue={10}
                aria-labelledby="discrete-slider"
          ...
          <div className="col-sm">
            <div className="form-group-dos text-center center-data">
              <div className="d-flex flex-row bd-highlight mb-3">
                <p className="p-2 bd-highlight circulo-icono-confirmav"><img src={MoneyIcon} alt="prestto-prestamos-en-linea-28"></img></p><p className="p-2 bd-highlight mini-text text-center">Recibiras está cantidad <br></br><span className="font-more-big">$ {this.state.setValue.toString() } mxn</span></p>
                </div>  
            </div>
          </div>
          <div className="col-sm">
        ...
        <div className="row">
          <div className="col-sm">
            <div className="form-group-dos text-left">
                ...
                <p className="esp-text">Sin IVA, para fines informativos y de comparación exclusivamente</p>
            </div>
          </div>
          <div className="col-sm">
...
datosCasa = () => {
  return (
    ...
    <div className="container">
        ...
        <div className="col-sm">
          <div className="row">
            <div className="col-sm">
              <div className="form-group">
                <div className="pointer_reenviar" onClick={this.sendSMS}> Reenviar código </div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="form-check">
              <input 
                ...
                <label className="form-check-label">
                  He leído y acepto los <a href="/terminosycondiciones" target="_blank">términos y condiciones</a>
                </label>
            </div>
          </div>
      </div>
    ...
    <div className="container container_button">
      <div className="row">
        <div className="col-sm mobile-col">
          <div className="pointer_atras" onClick={() => this.setState({stateView : 'datoscaso'})}> Atrás </div>
        </div>
        <div className="col-sm mobile-col">
      ...
      <div className="container">
        ...
        <div className="col-sm">
          <div className="form-group">
            ...
            />
            <span className={`warning-msg ${this.state.existemail ? "show error-msg" :'hide'}`}>El correo ya existe dirígete a <a href="/prestamo-en-linea-login"><span className="link-to">Mi cuenta</span></a></span>
                   ...
                   {/*<!-- <button className="btn btn-outline-secondary pointer btn_download" type="button" onClick={() => this.downloadFile()}>DESCARGAR</button> -->*/}
                    ...
                    <table className="contrato-table">
                      <tr className="row-contrato morado_bg">
                        ...
                        <td className="colr text-right"><b>NÚMERO DE CONTRATO:{idcontrato}</b></td>
                      </tr>
                    </table>
                    <table className="contrato-table">
                    ...
                    <table className="contrato-table">
                      <tr className="row-contrato-m">
                        <td className="td-ex text-center"><b>{ cattotal ? cattotal.toFixed(2) : cattotal }</b> <br></br>(Para fines informativos y de comparación exclusivamente) </td>
                    ...
                    <table className="contrato-table">
                      <tr className="row-contrato-m">
                        ...
                        <td className="td-ex text-center"><b>PLAZO DEL CRÉDITO APROBADO <br></br>{ fechadepagoen }</b></td>
                    ...
                    <table className="contrato-table">
                      <tr className="row-contrato-m">
                        ...
                        <td className="td-ex-b"><b>Fecha límite de pago: {fechadepagoen}<br></br>Fecha al corte: {fechadepagoen}</b></td>
                      </tr>
                    </table>
                    <table className="contrato-table">
                      <tr className="row-contrato-m">
                    ...
                    <div className="container-contrato">
                          <table className="font-contrato">
                            ...
                            b) Que su Registro Federal de Contribuyentes (RFC) es:<b> { rfc }</b>, y su Clave Única de Registro de Población es: <b>{curp}</b> .<br></br>
                            ...
                            <br></br> 
                      SEGUNDA. Disposición del Crédito. El CLIENTE dispondrá del Crédito en una sola exhibición mediante transferencia electrónica de dinero a la Cuenta Clave Bancaria Estandarizada (CLABE) { clabe } o mediante depósito al número de tarjeta  { tarjetadebito } que el CLIENTE tiene abierta en la institución bancaria denominada {bancotarjeta}, disposición que quedará sujeta a que existan recursos disponibles que permitan a PRESTTO a hacer la entrega respectiva. 
                            <br></br>    
                            ...
                            ***En caso de que la duración de la primer tasa no sea un número entero se redondeará al número entero próximo.
                            <br></br>   <br></br>
                            Duración Segunda Tasa = plazo del crédito otorgado – duración de la primer tasa.    <br></br>
                            <br></br>
                            ...
                            <br></br>
                            9.3 En caso de que el CLIENTE omita realizar el pago en la fecha pactada, se considerará en mora o cartera vencida al haber transcurrido el primer día contado a partir de la fecha límite de pago establecida en el presente contrato, según aplicable.   <br></br>
                            ...
                            EL CLIENTE por parte de PRESTTO, ya que se trata de un beneficio a EL CLIENTE y no una obligación por parte del mismo. 			   <br></br>
                            DÉCIMA. Comisiones. El CLIENTE se obliga a pagar a PRESTTO, los siguientes montos por concepto de Comisiones:   <br></br>
                            ...
                            <br></br><br></br>
                            La comisión por extensión será calculada de la siguiente manera:   <br></br>
                            Comisión por Extensión x Días a extender = Monto por los días de extensión   <br></br>
                            Monto por los días de extensión x Saldo a extender / 1000 = Monto de Comisión por Extensión   <br></br>
                            <br></br>       
                            ...
                            Pagaré
                            <br></br>				
                            NÚMERO DE CRÉDITO: 0000000 BUENO POR: $ 0000   <br></br>
