                                              ...
                                              <tbody>
                                                <tr width="100%" style="width: 100%">
                                                  <td style="text-align:center">
                                                    <p style="height:400px; background:linear-gradient(62deg,#5a6ff0,#c31fe6);">
                                                      <a href="https://prestto.mx/login" target="_blank">
                                                        <img src="https://prestto.mx/api/img/asset1.png" border="0" alt="PRESTTO" style="width: auto; border-radius: 0px; margin-left: 0px; margin-right: 0px; border: none; display: block;max-width: 600px" width="600" />
                                                      </a>
                                                    </p>
                                                  </td>
                                                </tr>
                                              ...
                                              <tbody>
                                                <tr width="100%" style="width: 100%">
                                                  <td style="width: 600px;" align="center" width="600" valign="top">
                                                        ...
                                                        <p style="color:#000;font-size:17px;text-align:center;font-family:Montserrat,Open Sans,sans-serif;line-height:1.2;font-weight:200">&iexcl;Est&aacute;s muy cerca de obtener tu préstamo&#33;</p>
                                                        <p style="color:#000;font-size:17px;text-align:left;font-family:Montserrat,Open Sans,sans-serif;line-height:1.2;font-weight:200;margin-left:50px">Recuerda que:</p>
                                                        <p style="color:#000;font-size:17px;text-align:left;font-family:Montserrat,Open Sans,sans-serif;line-height:1;font-weight:200;margin-left:70px">• Llenar tu solicitud es muy sencillo, no te tomar&aacute; m&aacute;s de 10 minutos.</p>
                                                        <p style="color:#000;font-size:17px;text-align:left;font-family:Montserrat,Open Sans,sans-serif;line-height:1;font-weight:200;margin-left:70px">• Una vez aprobado, tu pr&eacute;stamo ser&aacute; transferido inmediatamente.</p>
                                                        <p style="color:#000;font-size:17px;text-align:center;font-family:Montserrat,Open Sans,sans-serif;line-height:1;font-weight:200;margin-left:48px">• Cuando formas parte de la comunidad Prestto, puedes acceder a mejores pr&eacute;stamos.</p>
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="background-color: #323542;">
                                          <td style="padding:20px 30px">
                                              <p style="margin:0;padding:0;width:100%;text-align:center;line-height:0.8">
                                                <a href="" target="_blank">
                                                  <span style="font-family:Montserrat,Open Sans,sans-serif;font-size:10px;color:#fff;line-height:0.8">
