                                                            ...
                                                            <tbody>
                                                              <tr width="100%" style="width: 100%">
                                                                ...
                                                                <td style="width: 600px;" align="center" width="600" valign="top"> <a style="font-size: 10px" href="https://prestify.mx/" target="_blank">
                                                                  <img src="https://prestify.mx/api/img/logo.png" border="0" alt="Prestify" style="width: auto; border-radius: 0px; margin-left: 0px; margin-right: 0px; border: none; display: block;max-width: 100px" width="100" /></a>
